...
<body>
        ...
        <a href="rajastore.php"> <img src="eagle.png" alt="" class="logo"> <span>RAJA </span>STORE</a>
         <div>
             <ul id="navbar">
                 ...
                 <li><a href="shop.php"><i class="fa fa-cart-shopping"> Shop</i></a></li>
                 <li><a href="ticketing.php">Ticketing</a></li>
                 <li>  <a href="logout.php">  <?php echo $username; ?>  <i class="fa fa-right-to-bracket"> </i> </a> </li>
             </ul>
         </div>
    </section>
    ...
    <div class="pro-container">
        <div class="pro">
            ...
            <a href="choose.html"><i class="fa fa-shopping-cart"></i></a>
        </div>
        <div class="pro">
            ...
            <a href="choos2.html"><i class="fa fa-shopping-cart"></i></a>
        </div>
        <div class="pro">
            ...
            <a href="choos3.html"><i class="fa fa-shopping-cart"></i></a>
        </div>
